...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "VideoZoom")
    ...
    func saveContext () {
        ...
        if #available(iOS 10.0, *) {
            ...
            let content = NSManagedObjectContext(concurrencyType: .mainQueueConcurrencyType)
            content.persistentStoreCoordinator = coordinator
            content.mergePolicy = NSMergeByPropertyObjectTrumpMergePolicy
